...
If the agent worktree temporarily checks out another branch, sync waits for the
recorded agent branch to be checked out again before mutating either worktree.
