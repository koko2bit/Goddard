...
- Specific services—such as the Backend service (`@goddard-ai/backend`) and the Tauri App (`app`)—are licensed under the **GNU Affero General Public License v3.0 (AGPLv3)**.
