...
function TranscriptRow(props: { row: MessageListRow<RenderTranscriptItem> }) {
  if (props.row.item.kind === "toolGroup") {
    return <ToolTranscriptRow groupId={props.row.item.id} toolCalls={props.row.item.toolCalls} />
  }
...
export function Transcript(props: TranscriptProps) {
  ...
  const renderItems = useMemo(() => coalesceTranscriptItems(props.messages), [props.messages])

  return (
    <div class={cx(transcriptViewportClass, props.class)}>
      <MessageList<RenderTranscriptItem>
