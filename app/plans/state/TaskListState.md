...
- **Data Shape:** Normalized task records keyed by task id; ordered visible ids; filters for project, status, owner, and query; selected task id; loading and error state.
