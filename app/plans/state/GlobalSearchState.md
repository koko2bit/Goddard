...
- **Scope & Hoisting:** Hoisted into a global provider because search needs read access across sessions, pull requests, specs, tasks, roadmap items, actions, and projects.
