...
- **Data Shape:** Drafts keyed by action id or temporary draft id; metadata fields such as name and scope; prompt content; dirty status; validation errors; save status; source information describing whether the action is global or repository-local.
