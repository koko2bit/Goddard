...
- **Props Interface:** `displayUrl: string`; `committedUrl: string | null`; `canGoBack: boolean`; `canGoForward: boolean`; `isLoading: boolean`; `currentTabContext?: { kind, repositoryId?, entityRef? } | null`; `onBack: () => void`; `onForward: () => void`; `onRefresh: () => void`; `onStop?: () => void`; `onUrlChange: (value) => void`; `onUrlCommit: () => void`; `onActionSelect?: (actionId) => void`.
