...
- **Props Interface:** `pullRequest: { owner, repo, number, title, author, createdAt, status, headBranch, baseBranch, url }`; `relatedSessionId?: string`; `currentTabContext?: { kind, repositoryId?, entityRef? } | null`; `onOpenInBrowser: () => void`; `onOpenSession?: () => void`; `onRefresh: () => void`; `onActionSelect?: (actionId) => void`.
