...
- **Required Context:** `RoadmapContext`, `RepositoryRegistryContext`, `WorkbenchTabsContext`.
- **Tauri IPC:** None directly; roadmap reads and writes should route through shared proposal state.
