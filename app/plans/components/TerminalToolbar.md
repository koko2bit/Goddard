...
- **Props Interface:** `terminal: { title, cwdLabel, connectionState, exitCode? }`; `currentTabContext?: { kind, repositoryId?, entityRef? } | null`; `canRestart: boolean`; `onRestart: () => void`; `onClear: () => void`; `onClose: () => void`; `onActionSelect?: (actionId) => void`.
