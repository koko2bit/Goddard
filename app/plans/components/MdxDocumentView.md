...
- **Minimum Viable Component:** Document surface for viewing and editing MDX content with repository breadcrumbs, a mode-aware toolbar, and an `@mdxeditor/editor` integration boundary.
...
- **Required Context:** `MdxDocumentContext`, `RepositoryContentContext`.
