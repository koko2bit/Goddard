...
- **Minimum Viable Component:** Global modal search surface for discovering sessions, pull requests, specs, tasks, roadmap items, actions, and repositories from one query.
